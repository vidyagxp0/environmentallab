                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @endphp
                        ...
                        <button class="button_theme1"> <a class="text-white" href="{{ url('rootAuditTrial', $data->id) }}">
                            ...
                            @if ($data->stage == 1)
                                @if(Helpers::check_roles($data->division_id, 'Root Cause Analysis', 3))
                                    <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                        Acknowledge
                                    </button>
                                @endif

                                @if(Helpers::check_roles($data->division_id, 'Root Cause Analysis', 7))
                                    <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#cancel-modal">
                                        Cancel
                                    </button>
                                @endif
                            @endif
                            @if ($data->stage == 2 && Helpers::check_roles($data->division_id, 'Root Cause Analysis', 7))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Submit
                            </button>
                                            ...
                                            <div class="file-attachment-field">
                                                <div disabled class="file-attachment-list" id="root_cause_initial_attachment">
                                                    ...
                                                    <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                        ...
                                                        <a  type="button" class="remove-file" data-file-name="{{ $file }}" style="@if ($data->stage == 0 || $data->stage == 6) pointer-events: none; @endif"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                                    </h6>
                                               @endforeach
                                                    @endif
                                                </div>
                                                ...
                                                <div disabled class="file-attachment-list" id="cft_attchament_new">
                                                    ...
                                                    @if ($data->cft_attchament_new)
                                                        ...
                                                        <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                            <b>{{ $file }}</b>
                                                            <a href="{{ asset('upload/' . $file) }}" target="_blank"><i class="fa fa-eye text-primary" style="font-size:20px; margin-right:-10px;"></i></a>
                                                            <a  type="button" class="remove-file" data-file-name="{{ $file }}" style="@if ($data->stage == 0 || $data->stage == 3 || $data->stage == 6) pointer-events: none; @endif"><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                                        </h6>
                                                    @endforeach
                                                   {{-- @endif --}}
                                                   @endif
