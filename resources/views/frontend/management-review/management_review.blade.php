                                        ...
                                        <div class="file-attachment-field">
                                            <div disabled class="file-attachment-list" id="audit_file_attachment">
                                                ...
                                                <h6 type="button" class="file-container text-dark" style="background-color: rgb(243, 242, 240);">
                                                    ...
                                                    <a  type="button" class="remove-file"  data-remove-id="INATFile-{{ $loop->index }}" data-file-name="{{ $file }}" ><i class="fa-solid fa-circle-xmark" style="color:red; font-size:20px;"></i></a>
                                                </h6>
                                           @endforeach
                                                @endif
                                            </div>
