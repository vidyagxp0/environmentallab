            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        @if ($data->stage == 1 && Helpers::check_roles($data->division_id,'Internal Audit',13))
                        ...
                        @elseif($data->stage == 2 && Helpers::check_roles($data->division_id,'Internal Audit',12))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select id="assign_toe"
                                                    name="assign_to"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}>
                                                    <option value="">-- Select --</option>
                                                    @foreach ($users as $key => $value)
                                                        <option
                                                            value="{{ $value->id }}"{{ in_array($value->id, explode(',', $data->assign_to)) ? 'selected' : '' }}>
                                                            {{ $value->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="group-input input-date">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select
                                                    name="initiator_Group"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                    id="initiator_group">
                                                    <option value="">-- Select --</option>
                                                    <option value="CQA"
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <input name="short_description" id="docname" type="text"
                                                    maxlength="255" value="{{ $data->short_description }}" required
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                    ...
                                                    <option @if ($data->external_agencies == 'others') selected @endif
                                                        value="others">Others</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="group-input input-date">
                                                ...
                                                <div class="calenderauditee">
                                                    <input type="text" id="audit_schedule_end_date" readonly
                                                        placeholder="DD-MM-YYYY"
                                                        value="{{ Helpers::getdateFormat($data->audit_schedule_end_date) }}" />
                                            ...
                                            <div class="file-attachment-field">
                                                <div class="file-attachment-list" id="file_attachment_guideline">
                                                    @if ($data->file_attachment_guideline)
                                                        @foreach (json_decode($data->file_attachment_guideline) as $file)
                                                            <h6 type="button" class="file-container text-dark"
                                                                style="background-color: rgba(233, 224, 224, 0.92);">
                                                                <b>{{ $file }}</b>
                                                                <a href="{{ asset('upload/' . $file) }}"
                                                                    target="_blank"><i class="fa fa-eye text-primary"
                                                                        style="font-size:20px; margin-right:-10px;"></i></a>
                                                        ...
                                                        @if ($grid_data1 && $grid_data1->observation_id)
                                                            @foreach (unserialize($grid_data1->observation_id) as $key => $tempData)
                                                                <tr>
                                                                    <td>{{ $key + 1 }}</td>
                                                                    <td><input type="text"
                                                                            name="observation_id[]"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                                    ...
                                                                    <td><input type="text"
                                                                            name="observation_description[]"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                        ...
                                        <div class="group-input">
                                            ...
                                            <select multiple id="reference_record" name="capa_refrence_record[]"
                                                ...
                                                @foreach ($capa_old_record as $new)
                                                    <option value="{{ $new->id }}"
                                                        {{ in_array($new->id, explode(',', $data->capa_refrence_record)) ? 'selected' : '' }}>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <select multiple id="reference_record" name="cc_refrence_record[]"
                                                ...
                                                @foreach ($cc_old_record as $new)
                                                    <option value="{{ $new->id }}"
                                                        {{ in_array($new->id, explode(',', $data->cc_refrence_record)) ? 'selected' : '' }}>
                                                        {{ Helpers::getDivisionName($new->division_id) }}/Change
                                                        Control/{{ date('Y') }}/{{ Helpers::recordFormat($new->record) }}/{{ $new->short_description }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <select multiple id="reference_record" name="rca_refrence_record[]"
                                                ...
                                                @foreach ($rca_old_record as $new)
                                                    <option value="{{ $new->id }}"
                                                        {{ in_array($new->id, explode(',', $data->rca_refrence_record)) ? 'selected' : '' }}>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <select multiple id="reference_record" name="ai_refrence_record[]"
                                                ...
                                                @foreach ($action_items_old_record as $new)
                                                    <option value="{{ $new->id }}"
                                                        {{ in_array($new->id, explode(',', $data->ai_refrence_record)) ? 'selected' : '' }}>
                                                        {{ Helpers::getDivisionName($new->division_id) }}/Action
                                                        Item/{{ date('Y') }}/{{ Helpers::recordFormat($new->record) }}/{{ $new->short_description }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <div class="file-attachment-field">
                                                ...
                                                <div class="add-btn">
                                                    <div>Add</div>
                                                    <input type="file"
                                                        name="myfile[]"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
