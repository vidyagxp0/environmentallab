...
<body>
    ...
    <header>
        ...
        <table>
            <tr>
                ...
                <td class="w-40">
                   {{ Helpers::divisionNameForQMS($doc->division_id) }}/Extension/{{ Helpers::year($doc->created_at) }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
    ...
    <div class="inner-block">
        ...
        <div class="head">Extension Audit Trail Report</div>
