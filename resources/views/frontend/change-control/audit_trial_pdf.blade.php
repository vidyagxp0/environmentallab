    ...
    <header>
        <table>
            <tr>
                ...
                <td class="w-30">
                    <div class="logo">
                        <img src="https://dms.connexodemo.com/user/images/logo.png" alt="" class="w-100">
                    </div>
                </td>
            </tr>
        </table>
        <table>
            <tr>
                ...
                <td class="w-40">
                   {{ Helpers::getDivisionName($doc->division_id) }}/CC/{{ Helpers::year($doc->created_at)}}/{{ Helpers::record($doc->record) }}
                </td>
                <td class="w-30">
                    <strong>Record No.</strong> {{ Helpers::record($doc->record) }}
                </td>
            </tr>
        </table>
    </header>
