            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        @if ($data->stage == 1 && Helpers::check_roles($data->division_id,'Audit Program',3))
                        ...
                        @elseif($data->stage == 2 && Helpers::check_roles($data->division_id,'Audit Program',13))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Approve
                            </button>
                        ...
                        @elseif($data->stage == 3 && Helpers::check_roles($data->division_id,'Audit Program',13))
                                     ...
                                     <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="initiator_group_code" value="{{ $data->Initiator_Group}}" id="initiator_group_code" {{ $data->stage == 0 || $data->stage == 4 ? 'disabled' : '' }}
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                ...
                <tr>
                    ...
                    <td>
                        <select id="select-state" placeholder="Select..."
                            ...
                            @foreach ($users as $value)
                                <option
                                    {{ unserialize($AuditProgramGrid->auditor)[$key] == $value->id ? 'selected' : '' }}
                                    value="{{ $value->id }}">
                                    {{ $value->name }}
                                </option>
                            @endforeach
                    ...
                    <td>
                        <select id="select-state" placeholder="Select..."
                            ...
                            @foreach ($users as $value)
                                <option
                                    {{ unserialize($AuditProgramGrid->lead_investigator)[$key] == $value->id ? 'selected' : '' }}
                                    value="{{ $value->id }}">
                                    {{ $value->name }}
                                </option>
                            @endforeach
