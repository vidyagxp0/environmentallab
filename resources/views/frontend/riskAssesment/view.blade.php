                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="room" id="room"
                                                    {{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}>
                                                    <option value="">Enter Your Selection Here</option>
                                                    <option {{ $data->room == '1' ? 'selected' : '' }} value="1">
                                                        C-101</option>
                                                    <option {{ $data->room == '2' ? 'selected' : '' }} value="2">
                                                        C-202</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="group-input">
                                                ...
                                                <select {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }} multiple id="related_record" name="related_record[]" id="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="date" name="schedule_start_date1" value="{{$data->schedule_start_date}}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                        ...
                                        <div class="col-6">
                                            <div class="group-input">
                                                ...
                                                <textarea name="justification" id="justification">{{ $data->justification }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sub-head">
                                                ...
                                                <div><small class="text-primary">Please Attach all relevant or supporting documents</small></div>
                                                    <div class="file-attachment-field">
                                                       ...
                                                       @endforeach
                                                        ...
                                                        <div class="add-btn">
                                                            <div>Add</div>
                                                            <input {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }} type="file" id="myfile" name="reference[]"
                                                                oninput="addMultipleFiles(this, 'reference')" multiple>
                                                        </div>
                                                    </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <select name="mitigation_required" placeholder="Select Departments" data-search="false"
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <textarea name="mitigation_plan">{{ $data->mitigation_plan }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                <label for="mitigation-due-date">Mitigation Due Date</label>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <textarea name="mitigation_status_comments">{{ $data->mitigation_status_comments }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <textarea name="impact_analysis">{{ $data->impact_analysis }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="group-input">
                                                <label for="risk-analysis">Risk Analysis</label>
                                                <textarea name="risk_analysis">{{ $data->risk_analysis }}</textarea>
                                            </div>
                                        </div>
                                        {{-- <div class="col-lg-6">
                                            <div class="group-input">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="group-input">
                                                ...
                                                <select {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }} multiple id="reference_record" name="refrence_record[]">
                                                    <option value="">--Select---</option>
                                                    @foreach ($old_record as $new)
