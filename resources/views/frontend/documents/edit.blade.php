...
<div id="doc-lab" class="tabcontent">
    ...
    <div class="sub-head-2">Good Laboratory Practices</div>
    <div class="input-fields">
        <div class="row">           
            <div class="col-md-12">
                <div class="group-input">
            ...
            <div class="col-md-12">
                <div class="group-input">
                    <label for="responsibility">3.0 Responsibilities<span class="text-danger">*</span></label>
                    <span>The performance of the tests should be done by</span>
                    <select multiple_id = "responsibility">
                        <option>Select All</option>
                        <option>Amit</option>
                        <option>Manish</option>
            ...
            <div class="col-12">
                <div class="group-input">
                    <label for="11_Change_Control">
                        10.0 Change Control<button type="button" name="11_Change_Control"
                            id="11_Change_Control">+</button><span class="text-danger">*</span>
    ...
    <div class="input-fields">
        <div class="row">           
            ...
            <div class="col-12">
                <div class="group-input">
                    <label for="interpretation_of_result">
                        8.0 Critical Steps<button type="button" name="Critical Steps"
                            id="interpretation_of_result">+</button>
                    </label>
                    <table class="table table-bordered" id="interpretation_of">
                        <thead>
            ...
            <div class="col-md-12">
                <div class="group-input">
                    <label for="Software Processing Steps">9.0 Software Processing Steps <span class="text-danger">*</span></label>
                    <input type="text" id="Software Processing Steps" name="Software Processing Steps">
                </div>
                {{-- <p id="short_descError" style="color:red">**Short description is required</p> --}}
            ...
            <div class="col-md-12">
                <div class="group-input">
                    <label for="Calculation">10.0 Calculation<span class="text-danger">*</span></label>
                    <input type="text" id="Calculation" name="Calculation">
                </div>
                {{-- <p id="short_descError" style="color:red">**Short description is required</p> --}}
            ...
            <div class="col-md-12">
                <div class="group-input">
                    <label for="References">11.0 References<span class="text-danger">*</span></label>
                    <input type="text" id="References" name="Referencesn">
                </div>
                {{-- <p id="short_descError" style="color:red">**Short description is required</p> --}}
...
<!-- -------------------------------------------------------------------------------------------------------------------------------------------- -->
  ...
  text" id="scope_of_aplication" name="scope_of_aplication">
                </div>
                {{-- <p id="short_descError" style="color:red">**Short description is required</p> --}}
            ...
            <div class="col-md-12">l_Required">4.0 Materials/Chemical Required<span class="text-danger">*</span></label>
                    <input type="text" id="Chemical_Required" name="Chemical_Required">
                </div>
                {{-- <p id="short_descError" style="color:red">**Short description is required</p> --}}
