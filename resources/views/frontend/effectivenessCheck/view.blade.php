            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        @if ($data->stage == 1 && Helpers::check_roles($data->division_id, 'Effective Check ', 3))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Submit
                            </button>
                        @elseif($data->stage == 2 && Helpers::check_roles($data->division_id, 'Effective Check ', 14))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Effective
                            </button>
                        ...
                        @elseif($data->stage == 3 && Helpers::check_roles($data->division_id, 'Effective Check', 7))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                        ...
                        @elseif($data->stage == 5 && Helpers::check_roles($data->division_id, 'Effective Check', 7))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#rejection-modal">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input disabled type="text" name="division_code"
                                            value="{{ Helpers::getDivisionName($data->division_id) }}/EC/{{ Helpers::year($data->created_at) }}/{{ $data->record_number ? str_pad($data->record_number->record_number, 4, '0', STR_PAD_LEFT) : '' }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea type="text" name="Addendum_Comments"
                ...
                <div id="CCForm4" class="inner-block cctabcontent">
                    <div class="inner-block-content">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for="More Information Required (Not Effective) By"><b>More Information Required
                                            (Not Effective) By</b></label>
                                    <div class="static">{{ $data->more_info_required_not_effective_by }}</div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for="More Information Required (Not Effective) On"><b>More Information Required
                                            (Not Effective) On</b></label>
                                    <div class="static">{{ $data->more_info_required_not_effective_on }}</div>
                                </div>
                            </div>

                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for="Not Effective Approval Complete By"><b>Not Effective Approval Completed
                                            By</b></label>
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    <label for="Not Effective Approval Complete On"><b>Not Effective Approval Completed
                                            On</b></label>
                            ...
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <div class="static">{{ $data->more_info_required_effective_by }}</div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="group-input">
                                    ...
                                    <div class="static">{{ $data->more_info_required_effective_on }}</div>
                                </div>
                            </div>
