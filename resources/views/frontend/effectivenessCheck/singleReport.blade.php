    ...
    <header>
        ...
        <table>
            <tr>
                ...
                <td class="w-40">
                    {{ Helpers::divisionNameForQMS($data->division_id) }}/EC/{{ Helpers::year($data->created_at) }}/{{ str_pad($data->record_number->record_number, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
        ...
        <div class="content-table">
            ...
            <div class="block">
                ...
                <table>
                    ...
                    <tr>
                        <th class="w-20">More Information Required (Effective) By</th>
                        <td class="w-80">{{ $data->more_info_required_effective_by }}</td>
                        <th class="w-20">More Information Required (Effective) On</th>
                        <td class="w-80">{{ $data->more_info_required_effective_on }}</td>
                    </tr>

                    <tr>
                        <th class="w-20">More Information Required (Not Effective) By</th>
                        <td class="w-80">{{ $data->more_info_required_not_effective_by }}</td>
                        <th class="w-20">More Information Required (Not Effective) On</th>
                        <td class="w-80">{{ $data->more_info_required_not_effective_on }}</td>
                    </tr>
