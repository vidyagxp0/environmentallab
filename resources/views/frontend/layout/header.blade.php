        ...
        <div class="container-fluid header-bottom">
            <div class="container-fluid">
                <div class="bottom-links">
                    ...
                    @if (Auth::user())
                        @if (Helpers::check_roles_documents_new(3, Auth::user()->id) || Helpers::check_roles_documents_new(1, Auth::user()->id) || Helpers::check_roles_documents_new(2, Auth::user()->id)  || Helpers::check_roles_documents_new(7, Auth::user()->id) || Helpers::check_roles_documents_new(18, Auth::user()->id))
                            <div>
                                <a href="/mydms">My DMS</a>
                            </div>
                        @endif
                        @if (Helpers::check_roles_documents_new(3, Auth::user()->id) || Helpers::check_roles_documents_new(7, Auth::user()->id) || Helpers::check_roles_documents_new(2, Auth::user()->id) || Helpers::check_roles_documents_new(1, Auth::user()->id) || Helpers::check_roles_documents_new(18, Auth::user()->id))
                            <div>
                                <a href="{{ route('documents.index') }}">Documents</a>
                            </div>
                        @endif
                        @if (Helpers::check_roles_documents_new(1, Auth::user()->id) || Helpers::check_roles_documents_new(2, Auth::user()->id)  || Helpers::check_roles_documents_new(18, Auth::user()->id))
                            <div>
                                <a href="{{ url('mytaskdata') }}">My Tasks</a>
                            </div>
                        @endif
                    @endif
                    @if (Helpers::check_roles_qms(3, Auth::user()->id)  || Helpers::check_roles_documents_new(18, Auth::user()->id))
