 ...
 class RootCauseController extends Controller
{
    ...
    { 
        ...
        $rootCauseGrid =  new RootCauseAnalysesGrid();
        $root->measurement = json_encode($request->measurement);
        $root->materials = json_encode($request->materials);
        $root->methods = json_encode($request->methods);
        $root->environment = json_encode($request->environment);
    ...
    public function root_update(Request $request, $id)
    {
        ...
        $root->submitted_by = ($request->submitted_by);
        $root->Root_Cause_Category = json_encode($request->Root_Cause_Category);
        $root->Root_Cause_Sub_Category = json_encode($request->Root_Cause_Sub_Category);
        $root->Probability = json_encode($request->Probability);
        $root->Remarks = json_encode($request->Remarks);
        ...
        $root->why_4 = json_encode($request->why_4);
        $root->why_5 = json_encode($request->why_5);
        $root->why_root_cause = json_encode($request->why_root_cause);
        $root->why_problem_statement = json_encode($request->why_problem_statement);
